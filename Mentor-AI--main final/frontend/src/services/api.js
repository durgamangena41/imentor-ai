...
const api = {
  ...
  // --- Gamification Features (Team 6) ---
  getBounties: async () => {
    const response = await apiClient.get('/gamification/bounties');
    return response.data;
  },
  getUserScore: async () => {
    const response = await apiClient.get('/gamification/user-score');
    return response.data;
  },
  generateQuizChallenge: async (topic) => {
    const response = await apiClient.post('/gamification/quiz/generate', { topic });
    return response.data;
  },
  submitQuiz: async (bountyId, answers) => {
    const response = await apiClient.post('/gamification/quiz/submit', { bountyId, answers });
    return response.data;
  },
  ...
  regenerateWeakTopicChallenge: async (subTopic) => {
    const response = await apiClient.post('/gamification/challenge/regenerate-weak', { subTopic });
    return response.data;
  },
  submitSessionChallenge: async (bountyId, answers) => {
    const response = await apiClient.post(`/gamification/session-challenge/submit`, { bountyId, answers });
    return response.data;
  },

  getDiagnosticQuiz: async (topic) => {
    const response = await apiClient.post('/gamification/skill-tree/diagnostic', { topic });
    return response.data;
  },

  submitDiagnosticQuiz: async (topic, answers) => {
    const response = await apiClient.post('/gamification/skill-tree/diagnostic/submit', { topic, answers });
    return response.data;
  },

  // Skill Tree Game API
  generateLevels: async (payload) => {
    const response = await apiClient.post('/gamification/skill-tree/generate-levels', payload);
    return response.data;
  },
  saveGame: async (payload) => {
    const response = await apiClient.post('/gamification/skill-tree/games', payload);
    return response.data;
  },
  saveLevelProgress: async (gameId, levelId, payload) => {
    const response = await apiClient.put(`/gamification/skill-tree/games/${gameId}/level/${levelId}`, payload);
    return response.data;
  },
  completeLevel: async (payload) => {
    const response = await apiClient.post('/gamification/skill-tree/complete-level', payload);
    return response.data;
  },
  getLevelQuestions: async (payload) => {
    const response = await apiClient.post('/gamification/skill-tree/level-questions', payload);
    return response.data;
  },
  getSkillTreeGames: async () => {
    const response = await apiClient.get('/gamification/skill-tree/games');
    return response.data;
  },
